...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `<link rel="${"apple-touch-icon"}" sizes="${"180x180"}" href="${"/apple-touch-icon.png"}"><link rel="${"icon"}" type="${"image/png"}" sizes="${"32x32"}" href="${"/favicon-32x32.png"}"><link rel="${"icon"}" type="${"image/png"}" sizes="${"16x16"}" href="${"/favicon-16x16.png"}"><link rel="${"manifest"}" href="${"/site.webmanifest"}"><link rel="${"mask-icon"}" href="${"/safari-pinned-tab.svg"}" color="${"#5bbad5"}"><meta name="${"msapplication-TileColor"}" content="${"#da532c"}"><meta name="${"theme-color"}" content="${"#ffffff"}"><meta name="${"description"}" content="${"Welcome to The T-SPA"}">${($$result.title = `<title>The T-SPA</title>`, "")}`, "")}
...
<figure class="${"svelte-1kk9opm"}"><img alt="${"Success"}" src="${"successkid_rs40d5.webp"}" class="${"svelte-1kk9opm"}">
	<figcaption>Have fun with the T-SPA</figcaption></figure>
